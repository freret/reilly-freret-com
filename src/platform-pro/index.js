...
const PlatformProSupport = () => (
  <>
    ...
    <div style={{ display: "flex" }}>
      <img src={"img/main.png"} height={"300px"} alt={"Platform Pro main screen"} title={"Platform Pro main screen"} style={{ "margin-right": "20px" }} />
      <img src={"img/alerts.png"} height={"300px"} alt={"Platform Pro alerts screen"} title={"Platform Pro alerts screen"} style={{ "margin-right": "20px" }} />
      <img src={"img/alert_detail.png"} height={"300px"} alt={"Platform Pro alerts detail"} title={"Platform Pro alerts detail"} style={{ "margin-right": "20px" }} />
    </div>
